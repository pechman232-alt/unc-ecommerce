                ...
                success: function(data) {
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            option += `<option value="` + data[i]['id'] + `" {{ old('brand_id') }}>` + data[i][
                                "name"
                            ] + `</option>`;
                        }
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <hr class="my-0">
                    <div class="card-body">
                        <form action="{{ url('create-product') }}" method="POST" action="/upload"
                            ...
                            <div class="row mt-2">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select id="pro_type_id" onchange="selectProduct(this);" name="pro_type_id"
                                        class="form-select @error('pro_type_id') border-danger @enderror">
                                        <option value="" disabled selected>Select ProductTypes</option>
                                        @foreach ($productTypes as $product_type)
                                            <option value="{{ $product_type->id }}"
                                                @if (old('pro_type_id') == $product_type->id) {{ 'selected' }} @endif>
                                                {{ $product_type->type_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-4">
                            ...
                            <div class="row mt-2">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text"
                                        class="form-control @error('original_price') border-danger @enderror"
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text"
                                        class="form-control @error('price_after_discount') border-danger @enderror"
                                        name="price_after_discount" value="{{ old('price_after_discount') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="form-check form-switch mb-2">
                                                <input class="form-check-input" type="checkbox" name="isNewArrival" value="1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="form-check form-switch mb-2">
                                                <input class="form-check-input" type="checkbox" name="isHotSale" value="1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="file" value="{{ old('product_image') }}" name="product_image"
                                            id="select_image" onchange="selectImg()"
                                            class="form-control @error('product_image') border-danger @enderror">
                                    </div>
                                    <img id="target" class="mt-3 mb-2"
                                        src="{{ url('backend/assets/img/example-images/thumnail.png') }}" alt=""
                                        width="65%">
                                </div>
                                <div class="mb-3 col-md-5">
                                    <div class="form-group">
                                        <label>Images Detail:</label>
                                        <input type="file" name="product_images[]" id="select-image" multiple
                                            accept="image/*" class="form-control">
                                    </div>
                                    <div class="output" id="images"></div>
                                </div>
                            </div>
