...
@section('content')
    ...
    <main class="main">
        <div class="page-content" style="padding-top: 45px;">
            <div class="container">
                <h2 class="title">{{ $productTypes->type_name }}</h2>
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div class="sidebar sidebar-shop">
                            <div class="widget widget-collapsible">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-1" role="button" aria-expanded="false" aria-controls="widget-1">{{ $productTypes->type_name }}</a>
                                </h3>
                                            ...
                                            <div class="filter-item">
                                                <div class="custom-control custom-checkbox">
                                                    @foreach ($brands as $item)
                                                        <li>
                                                            <a href="{{ url('product-type-detail', encrypt($item->id)) }}">{{ $item->name }}</a>
                                                        </li>
                                                    @endforeach
                                                </div>
                                            </div>
