...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h2 class="mb-2 mx-2">Your session has expired!</h2>
            <p class="mb-4 mx-2">Please click the Login again.</p>
            <a href="{{ url('admin-unc') }}" class="btn btn-primary">Try to Login Again</a>
            <div class="mt-4">
