                    ...
                    <div class="collapse navbar-collapse" id="navbar-ex-3">
                        <div class="navbar-nav me-auto">
                            <a class="nav-item nav-link active" href="" style="font-size: 18px;"> <i
                                    class='bx bxs-school'></i> Product (New NewArrivals)</a>
                        </div>
            ...
            <div class="card-body">
                <div class="table-responsive text-nowrap">
                    <table id="datatable" class="display">
                        ...
                        <tbody>
                            @foreach ($getNewArrivals as $index => $item)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    <td style="width: 100px">
                                        <div class="btn-group" role="group" aria-label="First group">
                                            <a onclick="return confirm('Are you sure, you want to delete ?')" title="Delete user" href="{{ url('delete-NewArrival', encrypt($item->id)) }}" class="btn btn-outline-secondary" style="background-color: red; color:white"><i class="tf-icons bx bx-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
