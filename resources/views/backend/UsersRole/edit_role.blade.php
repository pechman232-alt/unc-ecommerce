        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <hr class="my-0">
                    <div class="card-body">
                        <form action="{{ url('update-role', encrypt($userRole->id)) }}" method="POST" action="/upload" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="basic-default-fullname">Role Name</label>
                                    <input type="text" class="form-control" name="role_name" placeholder="enter rolename" value="{{ $userRole->name }}">
                                </div>
                            </div>
                                ...
                                <div class="row gy-3">
                                    <div class="col-md">
                                        ...
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" {{ $mainMenu->checked == '1' ? 'checked': ''}} type="checkbox" value="{{ $mainMenu->id }}" id="{{ $mainMenu->id }}" name="ch_main[]">
                                    ...
                                    @foreach ($subMenus as $subMenu)
                                        @if ($subMenu->sub_of == $mainMenu->id)
                                            <div class="col-md">
                                                ...
                                                <div class="form-check mt-3">
                                                    <input class="form-check-input" {{ $subMenu->checked == '1' ? 'checked': '' }} type="checkbox" value="{{ $subMenu->id }}" id="{{ $subMenu->id }}" name="ch_sub[]">
