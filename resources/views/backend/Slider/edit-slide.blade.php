        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <hr class="my-0">
                    <div class="card-body">
                        <form action="{{ url('update-slide', encrypt($slider->id)) }}" method="POST" action="/upload" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                                <div class="card-body">
                                    <figure class="text-center mt-2">
                                        ...
                                        <img id="target" src="{{ url($slider->name == '' ? 'backend/assets/img/slider.png':'/slider/'.$slider->name) }}" alt class="my-img-2"/>
                                        <input type="file" name="image_slider" id="select_image" onchange="selectImg()"
